                    ...
                    ?>
                      <!-- Form cho phép người dùng upload file lên Server bắt buộc phải có thuộc tính enctype="multipart/form-data" -->
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <img src="/Pushh/assects/uploads/products/<?= $hinhsanphamRow['hsp_tentaptin'] ?>" class="img-fluid" width="300px" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="/Pushh/assects/uploads/products/" id="preview-img" width="200px" />
                            </div>
