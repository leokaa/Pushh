  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/Pushh/backend/pages/dashboard.php">Bảng tin</a>
      </li>
    </ul>
    <ul class="navbar-nav px-3 ml-auto">
      ...
      ?>
        ...
        <li class="nav-item text-nowrap">
          <a class="nav-link" href="/Pushh/backend/auth/logout.php">Đăng xuất</a>
        </li>
      <?php else : ?>
        <li class="nav-item text-nowrap">
          <a class="nav-link" href="/Pushh/backend/auth/login.php">Đăng nhập</a>
        </li>
      <?php endif; ?>
    </ul>
  </div>
